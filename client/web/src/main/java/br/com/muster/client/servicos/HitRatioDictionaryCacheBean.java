...
@ManagedBean
@ViewScoped
public class HitRatioDictionaryCacheBean extends AbstractBean {

    private Date inicio;
    private Date fim;

    private List<HitRatioDictionaryCache> registros;

    @EJB
    private HitRatioDictionaryCacheFacade hitRatioDictionaryCacheFacade;

    public HitRatioDictionaryCacheBean() {
        inicio = new Date();
        fim = new Date();
    ...
    public void selecionar() {
        ...
        if (empresa == null) {
            ...
            registros = hitRatioDictionaryCacheFacade.selecionarPorPeriodo(empresa.getId(), inicio, fim);
        }
    }
    ...
    public List<HitRatioDictionaryCache> getRegistros() {
        return registros;
    }

    public void setRegistros(List<HitRatioDictionaryCache> registros) {
