...
@ManagedBean
@ViewScoped
public class HitRatioLatchBean extends AbstractBean {

    private Date inicio;
    private Date fim;

    private List<HitRatioLatch> registros;

    @EJB
    private HitRatioLatchFacade hitRatioLatchFacade;

    public HitRatioLatchBean() {
        inicio = new Date();
        fim = new Date();
    ...
    public void selecionar() {
        ...
        if (empresa == null) {
            ...
            registros = hitRatioLatchFacade.selecionarPorPeriodo(empresa.getId(), inicio, fim);
        }
    }
    ...
    public List<HitRatioLatch> getRegistros() {
        return registros;
    }

    public void setRegistros(List<HitRatioLatch> registros) {
